...
Global $a, $array, $blurb, $blurbs, $case, $checked, $CheckerGUI, $clip, $date, $detail, $drop, $e, $entries, $entry, $exists, $favorite, $found
Global $game, $gamelist, $games, $gamesfile, $high, $i, $idx, $images, $imgfle, $inifle, $last, $left, $line, $logfle, $low, $method, $new
Global $numb, $nums, $oldlist, $owned, $path, $ping, $price, $prior, $r, $read, $remfile, $removals, $remove, $s, $savefile
Global $savfold, $savpth, $sect, $start, $state, $style, $target, $templist, $title, $top, $tot, $update, $usepth, $version
Global $webpage, $window, $wintit, $zoomlist
...
Func MainGUI()
	...
	;
	Local $added, $colnum, $dates, $download, $height, $icoI, $icoT, $icoW, $icoX, $imgurl
	Local $ind, $lowid, $released, $revamp, $shell, $store, $stores, $updated, $URL, $user32, $width
	;
	$width = 870
	$height = 405
	...
	;
	$Button_remove = GuiCtrlCreateButton("REMOVE", $width - 495, $height - 60, 75, 23)
	...
	;
	$Button_detail = GuiCtrlCreateButton("DETAIL", $width - 410, $height - 60, 70, 23)
...
Func DetailGUI()
	...
	;
	$Button_blurb = GUICtrlCreateButton("SAVE IMAGE FILE TO SELECTED LOCATION", 240, 245, 270, 45)
	GUICtrlSetFont($Button_blurb, 7, 600, 0, "Small Fonts")
	GUICtrlSetTip($Button_blurb, "Save the game image to a selected location!")
	;
	$Button_image = GUICtrlCreateButton("SAVE SUMMARY TO SELECTED LOCATION", 240, 300, 270, 45)
	GUICtrlSetFont($Button_image, 7, 600, 0, "Small Fonts")
	GUICtrlSetTip($Button_image, "Save the game summary to a selected location!")
	;
