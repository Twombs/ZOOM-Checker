...
Global $a, $array, $clip, $date, $drop, $exists, $found, $game, $gamelist, $games, $gamesfile, $i, $inifle
Global $last, $left, $line, $method, $new, $oldlist, $path, $r, $read, $s, $savfold, $savpth, $sect, $style, $target
Global $templist, $top, $tot, $updated, $usepth, $version, $webpage, $window, $wintit
...
Func MainGUI()
	Local $Button_check, $Button_detail, $Button_fav, $Button_info, $Button_log, $Button_own, $Button_quit, $Button_save, $Button_web
	Local $Combo_own, $Group_games, $Group_method, $Group_status, $Input_dates, $Input_game, $Label_status, $ListView_games, $Radio_box, $Radio_gui
	;
	Local $Input_dates, $e, $entries, $entry, $favorite, $height, $high, $icoI, $icoT, $icoW, $icoX, $idx, $ind, $low
	Local $lowid, $numb, $nums, $owned, $price, $prior, $shell, $start, $state, $store, $stores, $user32, $width
	;
	$width = 870
	$height = 405
	...
	GUICtrlSetTip($Button_log, "View log record!")
	;
	...
	If $stores = "" Then
		$stores = "||BigFish|Epic|GOG|Humble|IndieGala|Itch|Microsoft|Steam|ZOOM|"
	...
	If FileExists($gamesfile) Then
		...
		GUISetState($CheckerGUI, @SW_DISABLE + @SW_LOCK)
